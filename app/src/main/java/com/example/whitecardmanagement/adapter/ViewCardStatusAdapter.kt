...
class ViewCardStatusAdapter(private var listItems: MutableList<UpdateIT_Voting_Ration_Table>, private var context: Context, private val mListener: ListAdapterListener
): RecyclerView.Adapter<ViewCardStatusAdapter.ViewHolder>()  {
