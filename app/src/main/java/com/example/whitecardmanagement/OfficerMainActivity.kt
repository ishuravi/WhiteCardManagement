...
import com.example.whitecardmanagement.fragments.OfficerHomeFragment
import com.example.whitecardmanagement.helper.CommonMethods

class OfficerMainActivity : AppCompatActivity(),FragmentDrawer.FragmentDrawerListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.officer_activity_main)
        ...
        setfragment(OfficerHomeFragment())
    }
    ...
    fun logout() {
        AlertDialog.Builder(CommonMethods.context).setTitle(CommonMethods.context.getString(R.string.confirmation))
            ...
            .setPositiveButton(CommonMethods.context.getString(R.string.yes)) { _, _ ->
                ...
                intent = Intent(this@OfficerMainActivity, ChoseLoginActivity::class.java)
